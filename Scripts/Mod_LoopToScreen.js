class LoopToScreenMod extends Module
{
	constructor()
	{
	...
	Decorate( obj )
	{
		...
		obj.update += "if( this.x - " + diff.x + " < 0 ) this.x = gfx.scrWidth - 1 - " + diff.x + '\n'
		obj.update += "if( this.x + " + diff.x + " >= gfx.scrWidth ) this.x = " + diff.x + '\n'
		obj.update += "if( this.y - " + diff.y + " < 0 ) this.y = gfx.scrHeight - 1 - " + diff.y + '\n'
		obj.update += "if( this.y + " + diff.y + " >= gfx.scrHeight ) this.y = " + diff.y + '\n'
